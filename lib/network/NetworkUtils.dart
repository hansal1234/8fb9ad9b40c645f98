...
Future<model.MainResponse> parseConfig(dynamic json1) async {
    ...
    if (mModel != null) {
      ...
      if (mModel.appconfiguration != null) {
        ...
        await setValue(URL, mModel.appconfiguration!.url.isEmptyOrNull ? 'https://nixsum.co' : mModel.appconfiguration!.url);
